...
import com.example.mysololife22.contentsList.BookmarkModel
import com.example.mysololife22.contentsList.ContentModel
import com.example.mysololife22.contentsList.ContentShowActivity
import com.example.mysololife22.contentsList.ContentsListActivity
import com.example.mysololife22.utils.FBAuth
import com.example.mysololife22.utils.FBRef

class ContentRVAdaptor(val context : Context,
                       val item : ArrayList<ContentModel>,
                       val keyList : ArrayList<String>,
                       val bookmarkIdList : MutableList<String>) : RecyclerView.Adapter<ContentRVAdaptor.ViewHolder>() {
 ...
 */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContentRVAdaptor.ViewHolder {
        ...
        Log.d("ContentRVAdaptor",keyList.toString())
        Log.d("ContentRVAdaptor",bookmarkIdList.toString())
    return ViewHolder(v)
    }
